...
| `[ ... ](RO)` | 読み取り専用・任意 — `[ ... ]` と同様だがプロダクトコードの変更禁止 |
| `[[ ... ]](RO)` | 読み取り専用・必須 — `[[ ... ]]` と同様だがプロダクトコードの変更禁止 |
| `[ ... ](+W)` | 書き込み許可・任意 — `[ ... ]` と同様、プロダクトコードの編集を明示的に許可 |
| `[[ ... ]](+W)` | 書き込み許可・必須 — `[[ ... ]]` と同様、プロダクトコードの編集を明示的に許可 |
| `[ ... ](SK)` | スキル優先・任意 — `[ ... ]` と同様だがスキルとルールを明示的に検索し、既存スキルを使用 |
| `[[ ... ]](SK)` | スキル優先・必須 — `[[ ... ]]` と同様だがスキルとルールを明示的に検索し、既存スキルを使用 |
